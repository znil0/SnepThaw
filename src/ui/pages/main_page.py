...
def view(page: ft.Page):
    ...
    menu_layout = ft.Container(
        ...
        content=ft.Column(
            [
                ft.Text(value="MENU", color=TEXT_COLOR, weight="bold", size=18),
    ...
    image_layout = ft.Container(
        expand=True,
        content=ft.Image(src="assets/prueba.png", width=450, height=450, fit="contain"),
    )
